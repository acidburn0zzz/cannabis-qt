    ...
    QWidget(parent)
{
    ...
    showButton->setIcon(QIcon::fromTheme("view-refresh", QIcon(":/icons/16x16/view-refresh")));
    ...
    printButton->setIcon(QIcon::fromTheme("document-print", QIcon(":/icons/16x16/document-print")));
