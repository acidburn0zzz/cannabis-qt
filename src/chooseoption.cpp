    ...
    QWidget(parent)
{
    ...
    buttons["members"]->setIcon(QIcon::fromTheme("notification-message-im", QIcon(":/icons/elementary/notifications/48/notification-message-im")));
    ...
    buttons["quit"]->setIcon(QIcon::fromTheme("application-exit", QIcon(":/icons/elementary/actions/48/application-exit")));
